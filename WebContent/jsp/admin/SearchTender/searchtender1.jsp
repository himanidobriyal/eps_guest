...
<div class="search-criteria-options criteria-method-row">
  ...
  <div class="search-criteria-section" id="searchMethodWrapper" style="display:none;">
	...
	*Date range should be within one year
    ...
    Tender search results ${totalTenders}
...
<div class="pagination">
    ...
    <c:forEach begin="1" end="${totalPages}" var="i">
        ...
        <a href="searchtender.do?tab=${activeTab}&page=${i}"
...
document.addEventListener("DOMContentLoaded", function () {
	  handleSearchCriteriaChange("tenderNo");
	});
</script>
